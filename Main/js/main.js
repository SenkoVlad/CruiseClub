...
$(function () {
  $('.slick-vertical').slick({
    ...
    slidesToShow: 3,
    // autoplay: true,
    prevArrow: '<img src="img/arrow1.png">',
    nextArrow: '<img src="img/arrow2.png">'
  });
});
...
$(function () {
  $('.single-item-slider').slick({
    slidesToShow: 1,
    prevArrow: '<img src="img/arrow4.png">',
    nextArrow: '<img src="img/arrow3.png">'
  });
});

$(function () {
  $('.main__news .slick-arrow').filter(':first').addClass('slick-arrow-first');
  $('.main__review .slick-arrow').filter(':first').addClass('slick-arrow-review-first');
  $('.main__review .slick-arrow').filter(':last').addClass('slick-arrow-review-last');
